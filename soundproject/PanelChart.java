...
/**
 *
 * @author neel,shreyash,siddhi & Raj
 */
public class PanelChart {
  private final List<BasicStroke> listBscStrk = new ArrayList<>();   
  private final List<Color> listColor = new ArrayList<>();    
  private final List<Boolean> listView = new ArrayList<>();   
  private final List<String> listName = new ArrayList<>();  
  private final List<String> listLabel = new ArrayList<>(); 
...
//  private final List<Double []> listY = new ArrayList<>();
  ...
  private String vbleX = "", vbleY = ""; 
  private String titleY = "", titleX = ""; 
  private String titleM, titleS; 
  private Color backColor =  Color.WHITE;
  private Color extGridColor = Color.DARK_GRAY;
  private Color intGridColor = Color.DARK_GRAY; //Color(64, 64, 64);
  private Color midGridColor = Color.DARK_GRAY; //Color(128, 128, 128);
  private Color indNumbColor = Color.DARK_GRAY; //Color(192, 192, 192);
  private Color titleColor = Color.DARK_GRAY;
  private Color vbleXColor = Color.DARK_GRAY;
  private Color vbleYColor = Color.DARK_GRAY;
...
//    smphr.release();
  ...
  private void bubbleSortPairs(double[] aX, double[] aY) {
    ...
    if (aX.length != aY.length) throw new RuntimeException("Exeption e");
    double xTemp, yTemp;
  ...
  private double getMax(double[] data) {
    ...
    if (data.length < 1) throw new RuntimeException("Exeption e");
  ...
  public int addVble(String nVble, double[] aX, double[] aY, Color color) {
    ...
    quickSortPairs(aX, aY, 0, aX.length - 1);     
    listX.add(aX);
    listY.add(aY);
    listColor.add(color);
